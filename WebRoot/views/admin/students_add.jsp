...
$(".panel3").toggle();
  ...
  <jsp:include page="/views/head.jsp"/>
		<div id="container">
			<div class="container">
			<div class="header"><h1>输入学生信息</h1></div>
			...
			<center>
    			<form action="studentsServlet" method="post" id="form" onSubmit="return validate1()">
    			<table class="table4_2"  align="center" width="450" border="100" cellSpacing=1 style="border:1pt;font-size:15pt;"height="31">
    			<input type="hidden" name="Students" value="0"/>
    			<h4><tr><td>学号 ：</td><td><input type="text" name="student_id" class="{required:true}" placeholder="请输入学号"/></td></tr>
					<tr><td>姓名：</td><td><input type="text" name="student_name" placeholder="请输入姓名" /></td></tr></h4>
				<h4><tr><td colspan="2" align="center">性别 ：<input type="radio" name="gender" value="男" checked="checked" style="margin-left: 20px" />男
				...
				<h4><tr><td>班级 ：</td><td><input type="text" name="clazz" placeholder="请输入班级"/></td></tr>
					<tr><td>密码 ：</td><td><input type="text" name="password" placeholder="请输入密码"/></td></tr></h4>
	 			...
	 			<input class="button blue" type="submit" value="提交" style="margin-left: 30px" />
 					...
 					onclick="javascript:window.location.href='studentsServelt?Students=<%=1 %>';"/>
 				</td></tr>
 				</table>
    		</form>
    		</center>
