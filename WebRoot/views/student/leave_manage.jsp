		...
		<div class="container">
			...
			<div style="height:20px;  float:right" ></div>
				<table class="table4_2" align="center" width="90%" border="1" cellspacing="1" style="border: 1pt dashed; font-size: 15pt;" height="31px">
					...
					%>
					<td><a class="button red" href="leaveServlet?student_id=<%=Absence.getStudent_id()%>&methodName=<%=2%>"onclick="return confirmdialog()">删除</a>
						<a class="button gray" href="leaveServlet?leave_person=<%=Absence.getLeave_person()%>&methodName=<%=4%>">修改</a>
					</td>
					<%out.print("</tr>");}}%>
				</table><br>
				</div>
